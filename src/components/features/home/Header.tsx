            ...
            >
              {role === 'ADMIN' ? (
                ...
                <div className="flex items-center gap-3">
                  <Link
                    href="/auth/login"
                    className="border-purple text-purple font-paytone hover:bg-purple inline-block rounded-full border-2 px-5 py-2.5 text-base no-underline transition-all duration-200 hover:-translate-y-0.5 hover:text-white"
                  >
                    Đăng nhập
                  </Link>
                  <a
