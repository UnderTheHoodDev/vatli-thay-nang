  ...
  return (
    <section id="teacher" className="relative overflow-hidden bg-white py-20">
      ...
      <Image
        ...
        width={130}
        height={130}
        className="pointer-events-none absolute left-[34%] top-[18%] z-0 w-[130px]"
      />
      <Image
        src={ASSETS.pattern}
        alt=""
      ...
      <Image
        ...
        width={300}
        height={300}
        className="pointer-events-none absolute left-[-4%] top-[-4%] z-0 w-[24%]"
      />
      <Image
        src={ASSETS.line3}
        alt=""
      ...
      <div className="relative z-[1] mx-auto max-w-[1200px] px-6">
        {/* Header */}
        <motion.p
          className="mb-2 text-center font-cabin text-sm font-light tracking-[0.25em] text-[#503c39] uppercase"
        ...
        <motion.h2
          className="mb-2 text-center font-paytone text-[3rem] text-[#503c39] max-md:text-[2.2rem]"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.5 }}
        ...
        <motion.div
          className="mx-auto mb-12 h-[4px] w-[160px] rounded-full bg-gold"
        ...
        <div className="flex items-center gap-6 max-[968px]:flex-col">
          ...
          <div className="flex flex-1 flex-col items-end gap-8 text-right max-[968px]:hidden">
            {[ACHIEVEMENTS[0], ACHIEVEMENTS[2]].map((a, i) => (
              ...
              >
                ...
                <h3
                  className={`mb-1 font-paytone text-[1.25rem] ${
          ...
          <div className="hidden max-[968px]:grid grid-cols-2 gap-4 w-full">
            {ACHIEVEMENTS.map((a, i) => (
              ...
              >
                ...
                <h3
                  className={`mb-1 font-paytone text-[0.95rem] ${
                    a.titleColor === "pink" ? "text-pink" : "text-purple"
                  }`}
                >
                  {a.title}
