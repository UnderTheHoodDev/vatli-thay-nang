...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative flex min-h-screen items-end overflow-hidden bg-[#fffdf9] pt-[80px]"
    >
      <div className="relative z-[1] mx-auto flex w-full max-w-[1280px] items-end max-[968px]:flex-col max-[968px]:items-center max-[968px]:px-6 max-[968px]:pb-10">
        {/* Left: photo with Line 4 + Pattern behind it */}
        <motion.div
          className="relative flex flex-1 items-end justify-center self-stretch max-[968px]:w-full max-[968px]:max-h-[380px]"
        ...
        >
          ...
          <Image
            ...
            width={600}
            height={600}
            className="pointer-events-none absolute left-[-5%] top-[8%] z-0 w-[85%]"
          />
        ...
        {/* Right: text content */}
        <div className="relative flex-1 py-16 pr-8 pl-4 max-[968px]:py-8 max-[968px]:px-0 max-[968px]:text-center">
          <motion.h1
            className="mb-4 font-paytone leading-[1.2] text-[#503c39]"
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, ease: "easeOut", delay: 0.3 }}
          >
            {/* "CHINH PHỤC" inline with atom icon */}
            <span className="flex items-center gap-3 text-[2.8rem] max-md:text-[2rem] max-[968px]:justify-center">
              CHINH PHỤC
              <motion.div
            ...
            <span className="block font-paytone text-[2.2rem] text-purple max-md:text-[1.6rem]">
              các kì thi học sinh giỏi môn Vật Lí
            </span>
          </motion.h1>

          <motion.p
            className="mb-10 max-w-[440px] text-[1.05rem] italic leading-[1.6] text-[#503c39] max-[968px]:mx-auto"
              ...
              items.push(
                ...
                >
                  <Image
                    ...
                    className="h-13 w-13"
                  />
                  <span className="font-cabin text-[0.85rem] text-[#503c39]">
                    {feature.label}
                  </span>
                  <span
                    className={`font-paytone text-[1.1rem] ${feature.valueColor}`}
                  >
                    {feature.value}
                  </span>
                </motion.div>,
