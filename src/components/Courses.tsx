  ...
  return (
    <section id="courses" className="relative overflow-hidden bg-light-bg py-20">
      ...
      <Image
        ...
        width={560}
        height={560}
        className="pointer-events-none absolute left-[-8%] top-[-8%] z-0 w-[46%]"
      />
      ...
      <div className="relative z-[1] mx-auto flex max-w-[1200px] gap-8 px-6 max-[968px]:flex-col">
        ...
        <div className="flex flex-2 gap-6 max-[968px]:flex-col">
          {MAIN_COURSES.map((course, i) => (
            ...
            >
              ...
              <h3 className="mb-1 font-paytone">
                <span className="block text-[0.9rem] font-cabin font-normal text-[#503c39]">
                  {course.titlePrefix}
                </span>
                <span className="block text-[1.4rem] text-pink">{course.titleMain}</span>
              </h3>
              <p className="mb-1 text-[0.95rem] text-[#503c39] line-through">
                {course.price}
              </p>
              ...
              <div className="mt-auto flex items-center justify-between">
                ...
                <span className="text-[0.85rem] text-[#503c39]">
                  {course.dateRange}
                </span>
              </div>
            </motion.div>
        ...
        <div className="flex flex-1 flex-col gap-4">
          <motion.span
            className="self-end rounded-[20px] bg-[#dbeafe] px-5 py-2 font-paytone text-[0.85rem] text-[#2563eb]"
          ...
          {UPCOMING_COURSES.map((course, i) => (
            ...
            >
              ...
              />
              <div>
                <h4 className="mb-0.5 font-paytone text-[0.95rem] text-[#2563eb]">
                  {course.title}
                </h4>
