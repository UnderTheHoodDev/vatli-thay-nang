...
import type { IListClassSessionsParams, IListClassSessionsResult } from '@/types/actions/class-management';
...
export async function listClassSessions(
  ...
  try {
    ...
    return { data: [], meta: { total: 0, page: 1, pageSize: 20 }, errors: ['Lấy danh sách buổi học thất bại'] };
  }
}
